...
unlocked to sign the Atlacoin-Qt.app bundle.
...
allowing somebody to distribute a Atlacoin-Qt.app or atlacoin-qt-setup.exe with a valid
...
that the atlacoin-qt.exe file inside the installer had not been tampered with.
