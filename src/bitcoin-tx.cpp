...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s atlacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  atlacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded atlacoin transaction") + "\n" +
              "  atlacoin-tx [options] -create [commands]   " + _("Create hex-encoded atlacoin transaction") + "\n" +
              "\n";
