 ...
 * between atlacoind, and atlacoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/atlacoin/atlacoin>";
    const std::string URL_WEBSITE = "<https://atlacoin.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Atlacoin Developers", 2025)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Atlacoin useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Atlacoin More version %s\n", FormatFullVersion());
}
