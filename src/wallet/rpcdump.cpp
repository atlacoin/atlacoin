...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"atlacoinaddress\"\n"
            "\nReveals the private key corresponding to 'atlacoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"atlacoinaddress\"   (string, required) The atlacoin address for the private key\n"
            "\nResult:\n"
