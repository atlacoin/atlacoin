...
const QString BITCOIN_IPC_PREFIX("atlacoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/atlacoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/atlacoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/atlacoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click atlacoin: links
...
//
// OSX-specific way of handling atlacoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in atlacoin: URIs
