...
#if defined(NDEBUG)
# error "Atlacoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Atlacoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("atlacoin-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Atlacoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Atlacoin also requires low S in sigs
