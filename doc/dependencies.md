...
These are the dependencies currently used by Atlacoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/atlacoinnl
Keybase  - https://keybase.io/team/atlacoin/
